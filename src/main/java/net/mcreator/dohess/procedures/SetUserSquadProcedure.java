...
public class SetUserSquadProcedure {
	public static void execute(IWorld world, CommandContext<CommandSource> arguments, Entity entity) {
		if (entity == null)
			return;
		if ((StringArgumentType.getString(arguments, "setsquadname")).equals(DohessModVariables.WorldVariables.get(world).SLSquad1.substring(41, (int) ((DohessModVariables.WorldVariables.get(world).SLSquad1).length() - 55)))) {
			{
			...
			}
			{
				...
				if (!_ent.world.isRemote() && _ent.world.getServer() != null)
					_ent.world.getServer().getCommandManager().handleCommand(_ent.getCommandSource().withFeedbackDisabled().withPermissionLevel(4),
							("team modify " + ((entity.getCapability(DohessModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new DohessModVariables.PlayerVariables())).PlayerUser).toLowerCase() + " color blue"));
			}
			{
				Entity _ent = entity;
				if (!_ent.world.isRemote() && _ent.world.getServer() != null)
		...
		} else if ((StringArgumentType.getString(arguments, "setsquadname")).equals(DohessModVariables.WorldVariables.get(world).SLSquad2.substring(41, (int) ((DohessModVariables.WorldVariables.get(world).SLSquad2).length() - 55)))) {
			{
		...
		} else if ((StringArgumentType.getString(arguments, "setsquadname")).equals(DohessModVariables.WorldVariables.get(world).SLSquad3.substring(41, (int) ((DohessModVariables.WorldVariables.get(world).SLSquad3).length() - 55)))) {
			{
		...
		} else if ((StringArgumentType.getString(arguments, "setsquadname")).equals(DohessModVariables.WorldVariables.get(world).SLSquad4.substring(41, (int) ((DohessModVariables.WorldVariables.get(world).SLSquad4).length() - 55)))) {
			{
		...
		} else if ((StringArgumentType.getString(arguments, "setsquadname")).equals(DohessModVariables.WorldVariables.get(world).SLSquad5.substring(41, (int) ((DohessModVariables.WorldVariables.get(world).SLSquad5).length() - 55)))) {
			{
		...
		} else if ((StringArgumentType.getString(arguments, "setsquadname")).equals(DohessModVariables.WorldVariables.get(world).SLSquad6.substring(41, (int) ((DohessModVariables.WorldVariables.get(world).SLSquad6).length() - 55)))) {
			{
		...
		} else if ((StringArgumentType.getString(arguments, "setsquadname")).equals(DohessModVariables.WorldVariables.get(world).SLSquad7.substring(41, (int) ((DohessModVariables.WorldVariables.get(world).SLSquad7).length() - 55)))) {
			{
		...
		} else if ((StringArgumentType.getString(arguments, "setsquadname")).equals(DohessModVariables.WorldVariables.get(world).SLSquad8.substring(41, (int) ((DohessModVariables.WorldVariables.get(world).SLSquad8).length() - 55)))) {
			{
