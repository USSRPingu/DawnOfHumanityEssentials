...
public class SetRankProcedure {
	public static void execute(IWorld world, CommandContext<CommandSource> arguments, Entity entity) {
		...
		if ((StringArgumentType.getString(arguments, "priority")).equals("1")) {
			if ((DohessModVariables.WorldVariables.get(world).Rank1).equals("{\"text\":\"No Rank. \",\"color\":\"#424242\"}]")) {
			...
			} else {
				{
					Entity _ent = entity;
					if (!_ent.world.isRemote() && _ent.world.getServer() != null)
						_ent.world.getServer().getCommandManager().handleCommand(_ent.getCommandSource().withFeedbackDisabled().withPermissionLevel(4), ("" + "/tellraw @s {\"text\":\"This \\u200bpriority Is Taken\",\"color\":\"red\"}"));
				}
			}
		}
		if ((StringArgumentType.getString(arguments, "priority")).equals("2")) {
			if ((DohessModVariables.WorldVariables.get(world).Rank2).equals("{\"text\":\"No Rank. \",\"color\":\"#424242\"}]")) {
		...
		if ((StringArgumentType.getString(arguments, "priority")).equals("3")) {
			if ((DohessModVariables.WorldVariables.get(world).Rank3).equals("{\"text\":\"No Rank. \",\"color\":\"#424242\"}]")) {
		...
		if ((StringArgumentType.getString(arguments, "priority")).equals("4")) {
			if ((DohessModVariables.WorldVariables.get(world).Rank4).equals("{\"text\":\"No Rank. \",\"color\":\"#424242\"}]")) {
		...
		if ((StringArgumentType.getString(arguments, "priority")).equals("5")) {
			if ((DohessModVariables.WorldVariables.get(world).Rank5).equals("{\"text\":\"No Rank. \",\"color\":\"#424242\"}]")) {
		...
		if ((StringArgumentType.getString(arguments, "priority")).equals("6")) {
			if ((DohessModVariables.WorldVariables.get(world).Rank6).equals("{\"text\":\"No Rank. \",\"color\":\"#424242\"}]")) {
		...
		if ((StringArgumentType.getString(arguments, "priority")).equals("7")) {
			if ((DohessModVariables.WorldVariables.get(world).Rank7).equals("{\"text\":\"No Rank. \",\"color\":\"#424242\"}]")) {
		...
		if ((StringArgumentType.getString(arguments, "priority")).equals("8")) {
			if ((DohessModVariables.WorldVariables.get(world).Rank8).equals("{\"text\":\"No Rank. \",\"color\":\"#424242\"}]")) {
		...
		if ((StringArgumentType.getString(arguments, "priority")).equals("9")) {
			if ((DohessModVariables.WorldVariables.get(world).Rank9).equals("{\"text\":\"No Rank. \",\"color\":\"#424242\"}]")) {
		...
		if ((StringArgumentType.getString(arguments, "priority")).equals("10")) {
			if ((DohessModVariables.WorldVariables.get(world).Rank10).equals("{\"text\":\"No Rank. \",\"color\":\"#424242\"}]")) {
		...
		if ((StringArgumentType.getString(arguments, "priority")).equals("11")) {
			if ((DohessModVariables.WorldVariables.get(world).Rank11).equals("{\"text\":\"No Rank. \",\"color\":\"#424242\"}]")) {
		...
		if ((StringArgumentType.getString(arguments, "priority")).equals("12")) {
			if ((DohessModVariables.WorldVariables.get(world).Rank12).equals("{\"text\":\"No Rank. \",\"color\":\"#424242\"}]")) {
		...
		if ((StringArgumentType.getString(arguments, "priority")).equals("13")) {
			if ((DohessModVariables.WorldVariables.get(world).Rank13).equals("{\"text\":\"No Rank. \",\"color\":\"#424242\"}]")) {
		...
		if ((StringArgumentType.getString(arguments, "priority")).equals("14")) {
			if ((DohessModVariables.WorldVariables.get(world).Rank14).equals("{\"text\":\"No Rank. \",\"color\":\"#424242\"}]")) {
		...
		if ((StringArgumentType.getString(arguments, "priority")).equals("15")) {
			if ((DohessModVariables.WorldVariables.get(world).Rank15).equals("{\"text\":\"No Rank. \",\"color\":\"#424242\"}]")) {
		...
		if ((StringArgumentType.getString(arguments, "priority")).equals("16")) {
			if ((DohessModVariables.WorldVariables.get(world).Rank16).equals("{\"text\":\"No Rank. \",\"color\":\"#424242\"}]")) {
