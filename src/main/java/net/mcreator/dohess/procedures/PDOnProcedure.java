...
public class PDOnProcedure {
	public static void execute(IWorld world, Entity entity) {
			...
			return;
		{
			...
			if (!_ent.world.isRemote() && _ent.world.getServer() != null)
				_ent.world.getServer().getCommandManager().handleCommand(_ent.getCommandSource().withFeedbackDisabled().withPermissionLevel(4),
						("discordsrv broadcast PD Is Enabled By:" + (entity.getCapability(DohessModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new DohessModVariables.PlayerVariables())).PlayerUser));
		}
		{
			Entity _ent = entity;
			if (!_ent.world.isRemote() && _ent.world.getServer() != null)
				_ent.world.getServer().getCommandManager().handleCommand(_ent.getCommandSource().withFeedbackDisabled().withPermissionLevel(4),
						("tellraw @a [\"\",{\"text\":\"Permadeath\",\"underlined\":true,\"color\":\"dark_red\"},{\"text\":\"\\n\"},{\"text\":\"PD: \",\"color\":\"gold\"},{\"text\":\"Enabled\",\"color\":\"red\"},{\"text\":\"\\n\"},{\"text\":\"By: \",\"color\":\"gold\"},{\"text\":\""
								...
								+ "\",\"color\":\"aqua\"},{\"text\":\"\\n\"},{\"text\":\"The following changes are enabled\",\"underlined\":true},{\"text\":\"\\n\"},{\"text\":\"Respawning: \",\"color\":\"gold\"},{\"text\":\"False\",\"color\":\"red\"},{\"text\":\"\\n\"},{\"text\":\"Keep Inventory:\",\"color\":\"gold\"},{\"text\":\" False\",\"color\":\"red\"},{\"text\":\"\\n\"},{\"text\":\"Death messages: \",\"color\":\"gold\"},{\"text\":\"False\",\"color\":\"red\"},{\"text\":\"\\n\"},{\"text\":\"Discord - Minecraft chat: \",\"color\":\"gold\"},{\"text\":\"False\",\"color\":\"red\"},{\"text\":\"\\n\"},{\"text\":\"Public Chat: \",\"color\":\"gold\"},{\"text\":\"False\",\"color\":\"red\"}]"));
		}
		...
		DohessModVariables.WorldVariables.get(world).PD = 1;
